...
# read files
# We read the file
q_coefficient <- read_csv(here::here("Quadratic prog E", "data",
                                    "q_tech.csv")) # n tech s species

species_data <- read_csv(here::here("Quadratic prog E", "data",
                                    "species_data.csv")) # s species

species_group <- read_csv(here::here("Quadratic prog E", "data",
                                    "species_group.csv")) # m qb

effort_cost <- read_csv(here::here("Quadratic prog E", "data",
                                    "effort_costs.csv")) # n efforts

quota_cap <- read_csv(here::here("Quadratic prog E", "data",
                                    "quota_cap.csv")) # m qb
```
