---
title: "2 overfished and 1 stables"
...
# - when we group 2 stables with 1 overfished
# the rest of variables
# Species:
# s = species, r, K, X, p

s1 <- c(s=1, r=0.2, K=100, X=50, p=20) #Stable
s2 <- c(s=2, r=0.2, K=100, X=50, p=20) #Stable
s3 <- c(s=3, r=0.2, K=100, X=50, p=20) #Stable
s4 <- c(s=4, r=0.2, K=100, X=15, p=20) #overexploited
s5 <- c(s=5, r=0.2, K=100, X=15, p=20) #overexploited
...
# I dont know why it refuses to save in my G drive
  csvname <- "output_b_overfish2.csv"
