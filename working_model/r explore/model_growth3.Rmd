...
# - when we group 2 low r 1 high r
# - when we group 1 low r 1 high r
# the rest of variables
# Species:
# s = species, r, K, X, p

s1 <- c(s=1, r=0.1, K=100, X=50, p=20) #low r
s2 <- c(s=2, r=0.1, K=100, X=50, p=20) #low r
s3 <- c(s=3, r=0.1, K=100, X=50, p=20) #low r
