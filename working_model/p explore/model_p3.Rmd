...
# - when we group 2 high k and 1 normal k
# - when we group 2 normal k
...
s4 <- c(s=4, r=0.2, K=100, X=50, p=40) #high p 
s5 <- c(s=5, r=0.2, K=100, X=50, p=40) #high p
