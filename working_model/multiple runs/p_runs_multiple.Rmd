...
vec_param1 <-seq(2, 40, by = 2)
vec_param2 <-seq(2, 40, by = 2)
vec_param3 <-seq(2, 40, by = 2)
...
s1 <- c(s=1, r=0.2, K=100, X=50, p=test$vec_param1[y]) #overexploited
s2 <- c(s=2, r=0.2, K=100, X=50, p=test$vec_param2[y]) #overexploited
s3 <- c(s=3, r=0.2, K=100, X=50, p=test$vec_param3[y]) #overexploited
s4 <- c(s=4, r=0.2, K=100, X=50, p=40) #stable
s5 <- c(s=5, r=0.2, K=100, X=50, p=40) #stable
