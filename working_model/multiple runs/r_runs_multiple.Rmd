...
vec_param1 <-seq(0.02, 0.4, by = 0.02)
vec_param2 <-seq(0.02, 0.4, by = 0.02)
vec_param3 <-seq(0.02, 0.4, by = 0.02)
...
s1 <- c(s=1, r=test$vec_param1[y], K=100, X=50, p=20) #overexploited
s2 <- c(s=2, r=test$vec_param2[y], K=100, X=50, p=20) #overexploited
s3 <- c(s=3, r=test$vec_param3[y], K=100, X=50, p=20) #overexploited
s4 <- c(s=4, r=0.4, K=100, X=50, p=20) #stable
s5 <- c(s=5, r=0.4, K=100, X=50, p=20) #stable
...
```{r}
test_up <- test_profit_mult(param=20)
