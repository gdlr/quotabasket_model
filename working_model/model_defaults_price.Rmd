...
s1 <- c(s=1, r=0.15, K=100, X=50, p=30) 
s2 <- c(s=2, r=0.2, K=100, X=50, p=1)
s3 <- c(s=3, r=0.2, K=100, X=50, p=40)
...
path_store <- "C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/"
  csvname <- "opt_NPV_p30.1.40.10.20.csv"
