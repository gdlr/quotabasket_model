...
s1 <- c(s=1, r=0.15, K=100, X=50, p=1) 
s2 <- c(s=2, r=0.2, K=100, X=50, p=1)
s3 <- c(s=3, r=0.2, K=100, X=50, p=1)
s4 <- c(s=4, r=0.3, K=100, X=50, p=40)
s5 <- c(s=5, r=0.4, K=100, X=50, p=1)
