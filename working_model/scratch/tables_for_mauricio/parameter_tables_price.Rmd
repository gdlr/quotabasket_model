...
kbl(species_df, escape = F, caption = "Species Parameters for baskets based on price", col.names = c("Species", "r", "K", "Starting stock", "Price", "Run 1", "Run 2", "Run 3")) %>% 
   ...
   save_kable(file = here("working_model", "scratch", "optim", "plots", "price_sp_params.png"), zoom = 2)


kbl(tech_df, caption = "Technology matrix for baskets based on price", col.names = c("Technology", "Catchability\n sp. 1", "Catchability\n sp. 2", "Catchability\n sp. 3", "Catchability\n sp. 4", "Catchability\n sp. 5"), escape = F) %>% 
  kable_classic(full_width = F) #%>% 
  #save_kable(file = here("working_model", "scratch", "tables_for_mauricio", "plots", "price_t_params.png"), zoom = 2)
```
