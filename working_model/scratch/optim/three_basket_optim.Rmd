...
# Run this!
```{r}
output <- every_basket(species, tech, cost, n_baskets = 3, mort_guess, years)
...
write_csv(profits, here("working_model", "scratch", "optim", "data", "three_basket_profits.csv"))
write_csv(biomass, here("working_model", "scratch", "optim", "data", "three_basket_biomass.csv"))
```
