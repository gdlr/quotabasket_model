---
title: "Price difference of 10"
output: html_document
---

## Same parameters

Everything the same but prices are 5 different

It's only worth targeting the expensive fish.
...
s1 <- c(s=1, r=0.5, K=100, X=50, p=1) 
s2 <- c(s=2, r=0.5, K=100, X=50, p=11)
