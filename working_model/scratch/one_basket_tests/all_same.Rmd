...
This is a test run to make sure all this code works and the results return the same output.
...
t1 <- c(t=1, q1=0.05, q2=0)
t2 <- c(t=2, q1=0,    q2=0.05)
...
return(list(stock_plot = stock_plot, profit_plot = profit_plot))
}
...
species_table
tech_table
plots$stock_plot + plots$profit_plot
```
