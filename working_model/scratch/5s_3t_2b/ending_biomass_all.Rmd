...
s1 <- c(s=1, r=0.1, K=100, X=50, p=10) 
...
output <- qb_stock(species, tech, cost, baskets, mortality = max_p, years)
...
qb_allbaskets <- function(nBaskets, species, tech, cost, years){
  ...
  for(i in 1:length(mort_list)){
    ...
    out <- qb_stock(species = species, tech = tech, cost = cost, baskets = new_bs, mortality = mort, years = years)
