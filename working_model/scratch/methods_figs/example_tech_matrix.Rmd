...
t1 <- c(t=1, q1=0.04, q2=0.01, q3=0.01, q4=0.01, q5 = 0.1, cost = 1)
t2 <- c(t=2, q1=0.01, q2=0.04, q3=0.01, q4=0.01, q5 = 0.01, cost = 1.5)
t3 <- c(t=2, q1=0.01, q2=0.01, q3=0.04, q4=0.01, q5 = 0.01, cost = 1)
t4 <- c(t=2, q1=0.01, q2=0.01, q3=0.01, q4=0.04, q5 = 0.01, cost = 2)
t5 <- c(t=2, q1=0.01, q2=0.01, q3=0.01, q4=0.01, q5 = 0.04, cost = 3)
...
kbl(species_df, escape = F, caption = "Species Parameters for baskets based on r", col.names = c("Species", "r", "K", "Starting stock", "Price", "Run 1", "Run 2", "Run 3")) %>% 
   kable_classic(full_width = F) %>% 
   column_spec(6, color = c("pink", "pink", "pink", "lightblue", "lightblue")) %>% 
   column_spec(7, color = c("pink", "pink", "lightblue", "pink", "lightblue")) %>% 
   column_spec(8, color = c("pink", "lightblue", "lightblue", "pink", "lightblue")) %>% 
...
kbl(tech_df, align = "c", caption = "Example technology matrix", col.names = c("Technology", "Catchability\n sp. 1", "Catchability\n sp. 2", "Catchability\n sp. 3", "Catchability\n sp. 4", "Catchability\n sp. 5", "Cost"), escape = F) %>% 
  kable_classic(full_width = F) %>% 
  column_spec(7, border_left = T) %>% 
  save_kable(file = here("working_model", "scratch", "methods_figs", "example_tchMx.png"), zoom = 2)
```
