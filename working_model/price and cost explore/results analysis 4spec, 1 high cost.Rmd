...
setwd("C:/Users/kleigh/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/4spec/costs/def/cdef1112")
...
setwd("C:/Users/kleigh/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/4spec/costs/ident/cident1112")
temp = list.files(pattern="*.csv")
for (i in 1:length(temp))
