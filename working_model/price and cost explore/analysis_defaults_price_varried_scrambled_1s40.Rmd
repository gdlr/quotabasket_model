...
output_20 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_def_p20.csv")
...
output_p401111 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_def_p401111.csv")
NPV_def_p401111 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_def_p401111.csv")

output_p140111 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_def_p140111.csv")
NPV_def_p140111 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_def_p140111.csv")

output_p114011 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_def_p114011.csv")
NPV_def_p114011 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_def_p114011.csv")

output_p111401 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_def_p111401.csv")
NPV_def_p111401 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_def_p111401.csv")

output_p111140 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_def_p1all40.csv")
NPV_def_p111140 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_def_p1all40.csv")

NPVs <- rbind(NPV_20, NPV_def_p111140, NPV_def_p111401, NPV_def_p114011, NPV_def_p140111, NPV_def_p401111)
...
pfts_p1all40 <- output_p111140%>%    select(profit_per_t.t_1:profit_per_t.t_2.3) %>% 
 mutate(run = "1,1,1,1,40")

pfts_p111401 <- output_p111401%>%    select(profit_per_t.t_1:profit_per_t.t_2.3) %>% 
 mutate(run = "1,1,1,40,1")

pfts_p114011 <- output_p114011%>%    select(profit_per_t.t_1:profit_per_t.t_2.3) %>% 
 mutate(run = "1,1,40,1,1")

pfts_p140111 <- output_p140111%>%    select(profit_per_t.t_1:profit_per_t.t_2.3) %>% 
 mutate(run = "1,40,1,1,1")

pfts_p401111 <- output_p401111%>%    select(profit_per_t.t_1:profit_per_t.t_2.3) %>% 
 mutate(run = "40,1,1,1,1")

combo_pfts <- rbind(pfts_20, pfts_p1all40, pfts_p111401, pfts_p114011, pfts_p140111, pfts_p401111)
...
combo_pfts_f$run <- factor(combo_pfts_f$run, levels = unique(combo_pfts_f$run),
                             labels = c("Ex: $20 all", "Ex: Sp5- $40", "Ex: Sp4- $40", "Ex: Sp3- $40", "Ex: Sp2- $40", "Ex: Sp1- $40"))

pft_g <- ggplot()+
  geom_smooth(data = combo_pfts_f, aes(y=tots/1000, x=rep(0:30,6), color = as.factor(run)), se = FALSE)+ theme_minimal()+
...
stock_p1all40 <- output_p111140%>%    select(stock.s_1:stock.s_5) %>% 
 mutate(run = "1,1,1,1,40")

stock_p111401 <- output_p111401%>%    select(stock.s_1:stock.s_5) %>% 
 mutate(run = "1,1,1,40,1")

stock_p114011 <- output_p114011%>%    select(stock.s_1:stock.s_5) %>% 
 mutate(run = "1,1,40,1,1")

stock_p140111 <- output_p140111%>%    select(stock.s_1:stock.s_5) %>% 
 mutate(run = "1,40,1,1,1")

stock_p401111 <- output_p401111%>%    select(stock.s_1:stock.s_5) %>% 
 mutate(run = "40,1,1,1,1")

combo_stock <- rbind(stock_20, stock_p1all40, stock_p111401, stock_p114011, stock_p140111, stock_p401111)
...
stock_g <- ggplot()+
  geom_smooth(data = combo_stock_f, aes(y=tots, x=rep(0:30, 6), color = as.factor(run)), se = FALSE)+ theme_minimal()+
...
p2 <- p1 %+% filter(df$`Ex: Sp5- $40`, Species != "Fishery Wide")
p3 <- p1 %+% filter(df$`Ex: Sp4- $40`, Species != "Fishery Wide")
p4 <- p1 %+% filter(df$`Ex: Sp3- $40`, Species != "Fishery Wide")
p5 <- p1 %+% filter(df$`Ex: Sp2- $40`, Species != "Fishery Wide")
p6 <- p1 %+% filter(df$`Ex: Sp1- $40`, Species != "Fishery Wide")
