...
s1 <- c(s=1, r=0.2, K=100, X=50, p=params$species_p1) 
s2 <- c(s=2, r=0.2, K=100, X=50, p=params$species_p2)
s3 <- c(s=3, r=0.2, K=100, X=50, p=params$species_p3)
s4 <- c(s=4, r=0.2, K=100, X=50, p=params$species_p4)
s5 <- c(s=5, r=0.2, K=100, X=50, p=params$species_p5)
