...
setwd("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/costs/c11112/NPV/def/")
...
setwd("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/costs/c11112/NPV/ident/")
temp = list.files(pattern="*.csv")
for (i in 1:length(temp))
...
def_tech1h <- mget(ls(pattern="opt_NPV_def_c2.1.1.1.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
def_tech2h <- mget(ls(pattern="opt_NPV_def_c1.2.1.1.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
def_tech3h <- mget(ls(pattern="opt_NPV_def_c1.1.2.1.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
def_tech4h <- mget(ls(pattern="opt_NPV_def_c1.1.1.2.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
def_tech5h <- mget(ls(pattern="opt_NPV_def_c1.1.1.1.2")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
ident_tech1h <- mget(ls(pattern="opt_NPV_ident_c2.1.1.1.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
ident_tech2h <- mget(ls(pattern="opt_NPV_ident_c1,2.1.1.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
ident_tech3h <- mget(ls(pattern="opt_NPV_ident_c1.1.2.1.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
ident_tech4h <- mget(ls(pattern="opt_NPV_ident_c1.1.1.2.1")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
ident_tech5h <- mget(ls(pattern="opt_NPV_ident_c1.1.1.1.2")) %>% 
  as.data.frame() %>% 
  select(-contains("s_1."),
         -contains("s_2."),
         -contains("s_3."),
...
v1 <- ls(pattern = "ident_t|def_t|control_2")
...
stock_comp_g <- (plot_spacer()|p1|plot_spacer()) / (p2|p3|p4|p5|p6) / (p7|p9|p10|p11) + plot_annotation(
...
summaryinfo <- v2 %>%
  ...
  select(tot_pft, tot_biomass, run, linetype) %>% 
  summarise(av_pft = mean(tot_pft, na.rm = TRUE),
            av_biomass = mean(tot_biomass),
            run = unique(run),
