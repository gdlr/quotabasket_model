...
output_ex <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost exploreoutput_b_p10.20.50.100.200.csv")
NPV_ex <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost exploreNPV_b_p10.20.50.100.200.csv")
...
output_p1t40 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_p1t40.csv")
NPV_p1t40 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_p1t40.csv")

output_p1all40 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_p1all40.csv")
NPV_p1all40 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_p1all40.csv")

output_p10.70t100 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreoutput_p10.70t100.csv")
NPV_p10.70t100 <- read_csv("C:/Users/kll86/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/model run result files/price and cost exploreNPV_p10.70t100.csv")
...
# pft
ggsave(
  filename = 'pft_data_p_varried_constant_ex.jpg',
  plot = pft_g,
  path = path_store)

# stock
ggsave(
  filename = 'stock_data_p_varried_constant_ex.jpg',
  plot = stock_g,
  path = path_store)

ggsave(
  filename = 'stock_comp_p_varried_constant_ex.jpg',
  plot = stock_comp_g,
  path = path_store)
