...
t1 <- c(t=1, q1=0.04#, q2=0.04
        , q3=0.04, q4=0.04, q5 = 0.04)
#t2 <- c(t=2, q1=0.04#, q2=0.04, q3=0.04, q4=0.04, q5 = 0.04)
t3 <- c(t=2, q1=0.04#, q2=0.04
        , q3=0.04, q4=0.04, q5 = 0.04)
t4 <- c(t=2, q1=0.04#, q2=0.04
        , q3=0.04, q4=0.04, q5 = 0.04)
t5 <- c(t=2, q1=0.04#, q2=0.04
        , q3=0.04, q4=0.04, q5 = 0.04)
...
path_store <- "C:/Users/kleigh/OneDrive/Documents/UCSB/quotabasket_model/working_model/price and cost explore/"
  ...
  csvfile <- paste(path_store, "4spec_opt_NPV_ident_c", csvname, sep="")
